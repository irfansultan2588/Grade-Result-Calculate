function Resultcalculator() {
    ...
    let totalSubjectMarks = subject1Marks + subject2Marks + subject3Marks + subject4Marks + subject5Marks + subject6Marks;
    let parsantage = totalSubjectMarks * 100 / 600;

    document.querySelector("#totalSubjectMarks").innerHTML = `Total Subject Marks Is  ${totalSubjectMarks} / Out Of 600`;
    document.querySelector("#parsantage").innerHTML = `Your Parsantage Is  ${parsantage}%`;
